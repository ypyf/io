...
namespace io {
	...
	public class IoState {
        ...
        public List<IEnumerator<IoObject>> contextList = new List<IEnumerator<IoObject>>();

		public Dictionary<string, IoStateProto> primitives = new Dictionary<string, IoStateProto>();

        ///<summary>符号表</summary>
        public Dictionary<string, IoSeq> symbols = new Dictionary<string, IoSeq>();
		...
		{
			IoStateProto stateProto = primitives[name];
        ...
        public IoObject loadFile(string fileName)
        {
            ...
            using (var reader = new StreamReader(stream))
            {
			    ...
			    return onDoCStringWithLabel(lobby, s, fileName);
            }
        }
        ...
        public IoObject processBootstrap()
        {
            ...
            try
            {
                ios = Directory.GetFiles("libs/bootstrap");
            }
            catch {
            }
            ...
            List<string> iosa = new List<string>(ios);
            iosa.Sort();
