...
namespace io
{
    ...
    public class IoObjectArrayList : List<IoObject>
    {
    ...
    public class IoSeqObjectHashtable : Dictionary<IoSeq, IoObject>
    {
        public IoState state = null;
        public IoSeqObjectHashtable(IoState s) { state = s; }
        public IoObject this[string key]
        {
            get
            {
                return base[state.IOSYMBOL(key)];
            }
            set
            {
                base[state.IOSYMBOL(key)] = value;
            }
        }
    }
    ...
    public class IoObject
    {
        ...
        {
            IoObject o = target.slots[target.state.selfSymbol.ToString()];
            if (o != null && o != target)
